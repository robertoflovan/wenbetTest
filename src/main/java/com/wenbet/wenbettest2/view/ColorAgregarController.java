 ...
 * @author Roberto
 */
public class ColorAgregarController extends MyInitializableAgregar<Color> {
    ...
    @Override
    protected void fillData(Color entidad) {
        nombreField.setText(entidad.getNombre());
        marcaField.setText(entidad.getMarca());
    }

    @Override
    protected void actualizarEntidad(Color entidad) {

 ...
 * @author Roberto
 */
public class ActividadAgregarController extends MyInitializableAgregar<Actividad> {
    ...
    @Override
    protected void fillData(Actividad entidad) {
        nombreField.setText(entidad.getNombre());
    }

    @Override
    protected void actualizarEntidad(Actividad entidad) {
